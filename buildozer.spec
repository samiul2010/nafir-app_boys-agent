...
# The CI workflow copies the local Kivy override to this stable absolute path
# before Buildozer changes into its nested p4a working directory.
p4a.local_recipes = /home/p4a-recipes
